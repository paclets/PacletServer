		...
		KeySelect[
			GroupBy[
				Values[
					Merge[
						...
						PublicPacletServer`Build`BuildBits`Private`Git[
							"FileHistory",
							"/Users/Mark/Documents/GitHub/PacletServer/",
							"*/*.paclet"
						]
					]
				],
			...
			Function @ Greater[
				Length @ FileNames[
					...
					FileNameJoin @ {
						PublicPacletServer`Build`BuildBits`Private`dir$310059,
						"Paclets"
					}
				],
				0
